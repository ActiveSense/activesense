...
namespace ActiveSense.Desktop.Tests.ViewModelTests
{
    ...
    public class AnalysisPagesTests
    {
        ...
        public void Setup()
        {
            ...
            // Build service provider with real implementations
            ...
            // Register the analysis page view models
        ...
        #region SleepPageViewModel Tests
        ...
        #region ActivityPageViewModel Tests
        ...
        #region GeneralPageViewModel Tests
