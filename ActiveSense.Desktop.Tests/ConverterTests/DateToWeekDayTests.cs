...
namespace ActiveSense.Desktop.Tests.ConverterTests
{
    ...
    public class DateToWeekdayConverterTests
    {
        ...
        {
            // Arrange
            string dateString = "2024-05-20"; // This is a Tuesday (Dienstag)

            // Act
            string result = _converter.ConvertDateToWeekday(dateString);
        ...
        {
            // Arrange
            string saturdayString = "2024-05-18"; // This is a Saturday
            string sundayString = "2024-05-19"; // This is a Sunday

            // Act
            string saturdayResult = _converter.ConvertDateToWeekday(saturdayString);
            string sundayResult = _converter.ConvertDateToWeekday(sundayString);
        ...
        public void ConvertDateToWeekday_WithAllWeekdays_ReturnsAllGermanWeekdays()
        {
            ...
            {
                string result = _converter.ConvertDateToWeekday(dateStrings[i]);
        ...
        public void ConvertDateToWeekday_DateObjectConsistency_ReturnsConsistentWeekdays()
        {
            ...
            string expectedWeekday = germanCulture.DateTimeFormat.GetDayName(testDate.DayOfWeek);
